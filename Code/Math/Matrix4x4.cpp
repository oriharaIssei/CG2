...
Matrix4x4 Matrix4x4::inverse() const {
	...
	DirectX::XMMATRIX mat = MatrixToXMMATRIX();

	DirectX::XMVECTOR determinant = XMMatrixDeterminant(mat);
	DirectX::XMMATRIX inverseMatrix = DirectX::XMMatrixInverse(&determinant,mat);
	Matrix4x4 inv;
	inv.XMMATRIXToMatrix(inverseMatrix);
